...
function NewStatement() {
    ...
    function fetchStatements() {
        ...
        // axios.get('http://localhost:8080/api/v1/auth/getTransaction', { headers: { 'Authorization': 'Bearer ' + info } })
            axios.get('http://18.117.161.141:31372/api/v1/auth/getTransaction', { headers: { 'Authorization': 'Bearer ' + info } })
            .then((res) => {
                const data = res.data;
    ...
    function handleClick() {
        ...
        if (stype === "between") {
            ...
            // axios.post('http://18.117.161.141:31372/api/v1/auth/byDateBetween', dts, { headers: { 'Authorization': 'Bearer ' + info } })
